...
func TestGetLocalkubeDownloadURL(t *testing.T) {
	argsList := [...]getTestArgs{
		{"v1.3.0",
			"https://kubernetes.oss-cn-hangzhou.aliyuncs.com/minikube/k8sReleases/v1.3.0/localkube-linux-amd64", false},
		{"v1.3.3",
			"https://kubernetes.oss-cn-hangzhou.aliyuncs.com/minikube/k8sReleases/v1.3.3/localkube-linux-amd64", false},
